import { GraduationCap, UserPlus, Mail, Phone, Trash2, FileSpreadsheet } from "lucide-react";
          ...
          <tbody className="divide-y divide-slate-100 font-medium">
            {teachers.map(teach => (
              <tr key={teach.id} className="hover:bg-slate-50 transition">
                <td className="px-4 py-3 font-mono font-bold text-indigo-600">{teach.staff_code || `STF-${teach.id.substring(0, 5)}`}</td>
