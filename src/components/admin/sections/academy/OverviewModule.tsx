import { Users, GraduationCap, BookOpen, IndianRupee, TrendingUp, Send, FileText, BellRing, UserPlus, Sparkles, Calendar, Trophy, Target, Mail, Phone, AlertTriangle, CheckCircle2, XCircle, Wrench, X, Megaphone } from "lucide-react";
